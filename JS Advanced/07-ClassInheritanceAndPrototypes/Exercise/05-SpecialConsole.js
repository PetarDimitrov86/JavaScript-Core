...
console.log(Console.writeLine( {name: "Pesho"}));

//console.log(Console.writeLine('valid placeholder {0} replace', 'what', 'who'));
//console.log(Console.writeLine('valid placeholder {0} {1} replace', 'what', 'who'));
//console.log(Console.writeLine('valid placeholder {0} {1} replace', 'what'));
